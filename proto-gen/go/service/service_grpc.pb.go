...
const (
	AddService_GetMessages_FullMethodName = "/proto.AddService/GetMessages"
...
type AddServiceClient interface {
	GetMessages(ctx context.Context, in *Message, opts ...grpc.CallOption) (*MessageResponse, error)
...
func (c *addServiceClient) GetMessages(ctx context.Context, in *Message, opts ...grpc.CallOption) (*MessageResponse, error) {
	out := new(MessageResponse)
	err := c.cc.Invoke(ctx, AddService_GetMessages_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *addServiceClient) Multiply(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, AddService_Multiply_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AddServiceServer interface {
	GetMessages(context.Context, *Message) (*MessageResponse, error)
...
func (UnimplementedAddServiceServer) GetMessages(context.Context, *Message) (*MessageResponse, error) {
...
func _AddService_GetMessages_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Message)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AddServiceServer).GetMessages(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AddService_GetMessages_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AddServiceServer).GetMessages(ctx, req.(*Message))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _AddService_GetMessages_Handler,
		},
		{
			MethodName: "Add",
